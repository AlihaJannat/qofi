    ...
    <main class="login-container flex justify-center items-center py-12">
        <div class="container mx-auto flex justify-center">
            <div class="w-full max-w-2xl p-10 rounded shadow-sm bg-card-bg">
                <h2 class="text-4xl mb-8 font-extrabold text-black-5">Set new Password</h2>
                <form method="POST">
                    @csrf
                    <div class="mb-4">
                        <x-input-field label="Password" id="password" type="password" name="password" placeholder="Password" />
                    </div>
                    <div class="mb-4">
                        <x-input-field label="Confirm Password" id="password2" type="password" name="password_confirmation" placeholder="Password" />
                    </div>
