<div class="px-2 py-5 md:!px-10 relative">
    @if (count($featuredProducts))
        <div id="featuredProductsCarousel" class="owl-carousel owl-theme">
        ...
        <div class="absolute owl-nav-arrow z-10 bottom-24 hidden md:flex right-12 gap-2 justify-start">
            <div onclick="carouselPrev('featuredProductsCarousel')"
            ...
            <div onclick="carouselNext('featuredProductsCarousel')"
                class="p-2 cursor-pointer rounded-full border border-gray-300 flex justify-center items-center gap-8">
