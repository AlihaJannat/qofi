    ...
    <div class="row  shadow-md rounded-lg  mb-6">
        ...
        <div class="col col-sm-8 bg-white p-4 ">
            ...
            <div class="shopproducts">
                <ul class="list-unstyled">
                    ...
                    @foreach ($order->product as $productDetail)
                    <li>
            ...
            <!-- Total Price -->
            <div class="total">
                <h6>Delivery Charges: {{$currency}} {{ $order->delivery_charges }}</h6>
                <h6>Sub Total:{{$currency}} {{ $order->vendor_sub_total }}</h6>
                <h6><strong>Total Amount: {{$currency}} {{ $order->vendor_total }}</strong></h6>
            </div>
        </div>
        <div class="col-sm-4  p-4 customerdetail">
            ...
            <div class="bg-white p-4 rounded-lg mt-3">
                ...
                <p class="mb-0"><strong>Amount:</strong> {{ $order->payment->currency }} {{ $order->vendor_total }}
                </p>
            </div>
        </div>
