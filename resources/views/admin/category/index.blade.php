...
@section('content')
    @php
        ...
        $canCreate =
            auth('admin')->user()->roleRel?->permissions->contains('name', 'category_create') || $superAdmin;
        $canEdit = auth('admin')->user()->roleRel?->permissions->contains('name', 'category_edit') || $superAdmin;
        $canDelete =
            auth('admin')->user()->roleRel?->permissions->contains('name', 'category_delete') || $superAdmin;
    @endphp
            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        @if ($canCreate)
                            <a href="{{ route('admin.category.new') }}" class="btn btn-secondary create-new btn-primary"
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#categoryTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.category.yajra') }}",
                    data: function(d) {
                        d.canEdit = {{ $canEdit ?: 0 }};
