...
@section('content')
    @php
        ...
        $canCreate = auth('admin')->user()->roleRel?->permissions->contains('name', 'coupon_create') || $superAdmin;
        $canEdit = auth('admin')->user()->roleRel?->permissions->contains('name', 'coupon_edit') || $superAdmin;
        $canDelete = auth('admin')->user()->roleRel?->permissions->contains('name', 'coupon_delete') || $superAdmin;
    @endphp
