        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <form action="{{ route('admin.main-banner.img.change') }}" method="POST"
                            ...
                            <input type="file" id="myFile{{ $banner->id }}"
                                onchange="onMyFileChange(this, {{ $banner->id }})" name="image" style="display:none" />
                            ...
                            {{-- <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group-text">
                                        ...
                                        <input class="form-check-input mt-0" type="checkbox" id="hasButtonCheckbox"
                                            name="has_button" value="1" {{ $banner->has_button ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div> --}}
                            <div class="col-12">
                                <div class="form-group">
                                    <x-toggle-input label="Has Button" id="has_button" name="has_button"
                                        value="{{$banner->has_button}}" />
                                    {{-- <div class="input-group-text"> --}}
                                        {{-- <input type="hidden" name="has_button" value="0">
                                        <input class="form-check-input mt-0" type="checkbox"
                                            aria-label="Checkbox for following text input" name="has_button" value="1"
                                            id="hasButtonCheckbox"> --}}
                                        {{--
                                    </div> --}}
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6 pr-1">
                                            <div class="form-group">
                                                <x-color-input name="button_color" id="button_color"
                                                    label="Button Color" value="{{$banner->button_color}}" />
