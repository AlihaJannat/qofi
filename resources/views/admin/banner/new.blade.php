...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <a href="{{ route('admin.banner.index') }}" class="text-muted fw-light">Banner /</a> New
        </h4>
        <div class="row  px-5">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.banner.new') }}" class="row g-3" method="post"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="main-image" name="image_name" class="form-control"
