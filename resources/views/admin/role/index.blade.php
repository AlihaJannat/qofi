        ...
        <div class="modal-dialog modal-dialog-centered modal-xl modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form class="add-new-role pt-0" onsubmit="addRole(event, this)" action="{{ route('admin.role.add') }}">
                        @csrf
                        {{ csrf_field() }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            getDetails = function(id) {
                ...
                $.ajax({
                    url: "{{ route('admin.role.getDetails') }}",
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        id: id
            ...
            permissionCheck = function(itSelf, permission) {
                ...
                dependentArray = ['edit', 'create', 'delete', 'management', 'status', 'pending']
